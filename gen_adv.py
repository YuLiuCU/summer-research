...
# loss,acc = deeplob.evaluate(testX_CNN, testY_CNN, verbose=2)
...
testX_CNN_ADV_ori=testX_CNN[0:n,:,:,:]
testY_CNN_ADV=testY_CNN[0:n,:]

loss,acc = deeplob.evaluate(testX_CNN_ADV_ori, testY_CNN_ADV, verbose=2)
